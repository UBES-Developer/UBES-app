    ...
    return (
        <div className="p-6 space-y-6 bg-slate-50 min-h-screen relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <Card className="col-span-1 lg:col-span-4 shadow-sm">
                    ...
                    <CardContent className="grid grid-cols-3 gap-4">
                        <div className="flex items-center space-x-4 p-4 bg-white rounded-lg border border-slate-100">
                            ...
                            <div>
                                <div className="flex items-center gap-1" title="Real-time connectivity status to Supabase Postgres.">
                                    <p className="text-sm font-medium text-slate-500 cursor-help">Database</p>
                        ...
                        <div className="flex items-center space-x-4 p-4 bg-white rounded-lg border border-slate-100">
                            ...
                            <div>
                                <div className="flex items-center gap-1" title="Remaining tokens for AI Chat and Smart Grading features.">
                                    <p className="text-sm font-medium text-slate-500 cursor-help">AI Credits</p>
                                    <HelpCircle className="h-3 w-3 text-slate-400" />
                                </div>
                        ...
                        <div className="flex items-center space-x-4 p-4 bg-white rounded-lg border border-slate-100">
                            ...
                            <div>
                                <div className="flex items-center gap-1" title="Used capacity for academic resources and user uploads.">
                                    <p className="text-sm font-medium text-slate-500 cursor-help">Storage</p>
                                    <HelpCircle className="h-3 w-3 text-slate-400" />
                                </div>
                        ...
                        <div className="pt-2">
                            <Button variant="outline" size="sm" className="w-full text-indigo-600 border-indigo-200 hover:bg-indigo-50" asChild>
                                <Link href="/admin/users">
                                    <User className="mr-2 h-4 w-4" /> View All Users
                                </Link>
                            </Button>
                        </div>
                    </CardContent>
                ...
                <Link href="/admin/resources" className="block col-span-1">
